          ...
          {showDisclaimer && (
            <div className="absolute right-0 mt-2 w-64 bg-white border border-yellow-400 rounded-lg shadow-xl p-4 text-xs text-gray-700">
              ...
              <p>
                ...
                take 10–30 seconds to wake up after inactivity. Thanks for your
                patience 🙏
              </p>
            </div>
          )}
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden relative">
          ...
          <div className="grid lg:grid-cols-5 gap-0">
            <div className="lg:col-span-3 bg-gradient-to-br from-indigo-500 via-purple-600 to-pink-700 p-6 flex items-center justify-center relative overflow-hidden">
              ...
              <div className="absolute top-1/2 left-6 w-6 h-6 bg-orange-400 rounded-full opacity-50"></div>
              ...
              <div className="text-center relative z-10">
                <div className="relative mb-3">
                  ...
                  <div className="absolute -bottom-2 -right-2 w-10 h-10 bg-gradient-to-r from-green-400 to-blue-500 rounded-xl flex items-center justify-center shadow-lg animate-pulse">
              ...
              <div className="w-full max-w-sm">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full mt-4 py-3 px-4 bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-600 hover:from-yellow-500 hover:via-pink-600 hover:to-purple-700 text-white text-sm font-black rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none relative overflow-hidden"
                  >
                    {isLoggingIn ? (
                ...
                <div className="mt-4 text-center">
                  <Link
                    to="/signup"
                    className="text-gray-600 hover:text-purple-600 transition-colors duration-300 font-semibold text-xs group"
                  >
                    Don't have an account?
                    <span className="ml-1 text-purple-600 group-hover:translate-x-1 inline-block transition-transform duration-300">
                      Sign Up →{" "}
                    </span>
                  </Link>
                </div>
